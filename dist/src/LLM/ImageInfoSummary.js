...
exports.imageInfoSummary = void 0;
...
const imageInfoSummary = (prompt) => __awaiter(void 0, void 0, void 0, function* () {
    var _a, _b, _c, _d, _e;
    try {
        if (!prompt) {
        ...
        return (_d = (_c = (_b = (_a = response.data.candidates[0]) === null || _a === void 0 ? void 0 : _a.content) === null || _b === void 0 ? void 0 : _b.parts[0]) === null || _c === void 0 ? void 0 : _c.text) !== null && _d !== void 0 ? _d : null;
    }
    catch (error) {
...
exports.imageInfoSummary = imageInfoSummary;
